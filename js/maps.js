...
function initMap(map) {
    ...
    /** --------------------------- Geolocation control ---------------------------------- **/
    var geoLocationLayer = new OpenLayers.Layer.Vector("Geo")
    ...
    geolocate.events.register(
        ...
        function(e) {
            ...
            if (map.controlList.geolocation.follow) {
                pulsate(circle, geoLocationLayer);
                this.bind = true;
                map.controlList.geolocation.follow = false;
            }
    });
    ...
    map.controlList.geolocation =geolocate;
...
/** -------------------- Force GeoLocation --------------------- **/
function geoLocateNow(map) {
    map.controlList.geolocation.deactivate();
    map.controlList.geolocation.follow = true;
    map.controlList.geolocation.watch = false;
    map.controlList.geolocation.activate();
}
...
/** ---------------------------------------------------------------------------------- **/
//$(function() {
    OpenLayers.ImgPath = Properties.SITE_ROOT_PATH + Properties.OPENLAYERS_IMG_PATH;
    ...
    setInterval(function() { geoLocateNow(olMap); } , 30000);
    /** ----------------------------------- Externals -------------------------------------- **/
